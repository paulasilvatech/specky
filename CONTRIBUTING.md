...
Specky v3.4.0 is an MCP server that exposes **58 tools** organized into a 10-phase Spec-Driven Development pipeline. The codebase comprises **88 source files**, **22 templates**, and is structured as follows:
