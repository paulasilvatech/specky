  ...
  api: [
    {
      ...
      question:
        "Which named consumers call the API, through which protocol, and which compatibility versions must remain supported?",
      why_it_matters:
        "Consumer and protocol contracts determine versioning and compatibility obligations.",
      required_evidence: "Consumer inventory, protocol, current and target API versions",
    },
    {
      category: "API operations and authorization",
      question:
        "Which operations, request/response schemas, authentication methods, and authorization rules are required?",
      why_it_matters:
        "Operations cannot be designed safely without exact schemas and access rules.",
      required_evidence: "Operation table with methods, paths, schemas, authn and authz",
    },
    {
      category: "API failure contract",
      question:
        "What error model, idempotency behavior, retry semantics, quotas, and rate limits apply to each operation class?",
      why_it_matters: "Failure semantics and traffic policies are public API behavior.",
      required_evidence:
        "Error catalog, idempotency keys, retry policy, quota and rate-limit table",
    },
  ],
  "web-application": [
    {
      ...
      question:
        "Which named user journeys and UI states must the web application support from entry through completion or abandonment?",
      why_it_matters: "Journey and state coverage defines the actual interaction surface.",
      required_evidence:
        "Journey map including loading, empty, success, validation and failure states",
    },
    {
      category: "Accessibility and responsiveness",
      question:
        "Which accessibility standard, input methods, breakpoints, and responsive adaptations are mandatory?",
      why_it_matters:
        "Accessibility and viewport behavior must be designed, not inferred after implementation.",
      required_evidence:
        "Accessibility target, keyboard behavior, screen-reader semantics and breakpoint matrix",
    },
    {
      category: "Web integration",
      question:
        "How are sessions, browser security boundaries, client data, backend APIs, caching, and offline behavior managed?",
  ...
  service: [
    {
      ...
      question:
        "Which named callers invoke the service, through which protocols, and with which latency and availability objectives?",
    ...
    },
    {
      ...
      question:
        "Which downstream dependencies exist, and what timeout, retry, circuit-breaking and idempotency policies apply to each?",
    ...
    },
    {
      ...
      question:
        "What deployment, scaling, health, telemetry, alerting and incident-response requirements govern the service?",
  ...
  cli: [
    {
      ...
      question:
        "Which commands, subcommands, arguments, options, defaults and mutual-exclusion rules make up the CLI grammar?",
    ...
    },
    {
      ...
      question:
        "What is written to stdout and stderr, which exit codes are stable, and how do interactive and non-interactive modes differ?",
    ...
    },
    {
      ...
      question:
        "Which shells, operating systems, configuration sources, authentication methods and installation mechanisms are supported?",
  ...
  library: [
    {
      category: "Public API",
      question:
        "Which exported modules, types, functions and extension points form the supported library API?",
    ...
    },
    {
      ...
      question:
        "Which languages, runtimes, package managers and previous versions must consumers be able to use?",
    ...
    },
    {
      ...
      question:
        "Which error types, resource ownership rules, performance limits and consumer examples define correct usage?",
  ...
  infrastructure: [
    {
      ...
      question:
        "Which providers, regions, environments, resource types, connectivity boundaries and availability zones are required?",
    ...
    },
    {
      ...
      question:
        "Where is state stored, how is locking handled, which identities deploy and run resources, and which network paths are permitted?",
    ...
    },
    {
      ...
      question:
        "What drift, policy, cost, backup, disaster recovery, observability and lifecycle requirements apply?",
...
function lifecycleQuestions(
    ...
    return [
      {
        ...
        why_it_matters:
          "A new system needs a bounded outcome before technology or architecture is selected.",
        required_evidence: "Outcome measures, in-scope and out-of-scope list, stakeholder owners",
      },
      {
        category: "Greenfield constraints",
        question:
          "Which technology, delivery, budget, data-residency, security and operational constraints are already decided versus still open?",
  ...
  if (contract.lifecycle === "brownfield") {
    ...
    return [
      ...
      },
      {
        ...
        question:
          "Which existing behaviors, interfaces, data formats, deployment processes and operational guarantees must remain unchanged?",
      ...
      },
      {
        ...
        question:
          "Where will the change be introduced, how will it coexist with existing components, and what rollback boundary is available?",
  ...
  return [
    ...
    },
    {
      ...
      question:
        "What data conversion, validation, coexistence, cutover, rollback and decommission sequence is required?",
      why_it_matters:
        "Migration safety is determined by transition mechanics, not only target design.",
      required_evidence:
        "Wave plan, validation gates, cutover criteria, rollback plan and decommission checklist",
    },
  ];
}
...
export function renderWorkloadDesign(
  ...
  if (input.type !== expectedWorkload) {
    throw new Error(
      `Design payload type ${input.type} does not match feature workload ${expectedWorkload}.`,
    );
  }
