...
export const exportWorkItemsInputSchema = z
  .object({
    feature_number: featureNumberSchema,
    spec_dir: specDirSchema,
  })
...
export const createPrInputSchema = z
  .object({
    feature_number: featureNumberSchema,
    spec_dir: specDirSchema,
  })
...
export const implementInputSchema = z
  .object({
    feature_number: featureNumberSchema,
    spec_dir: specDirSchema,
    task_ids: z
  ...
  .object({
    ...
    entries: z
      .array(
        z
          .object({
            id: z.string().min(1).describe("Unique question ID (e.g., 'RQ-001')"),
            question: z.string().min(10).describe("The research question to resolve"),
            context: z
              .string()
              .min(3)
