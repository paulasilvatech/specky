...
Thank you for your interest in contributing to Specky. This guide covers the v3.12.1 architecture, development patterns, and submission process.
...
Specky v3.12.1 is an MCP server that exposes **58 tools** organized around signed, per-feature use-case contracts. The codebase comprises **127 TypeScript source files**, **22 templates**, and is structured as follows:
