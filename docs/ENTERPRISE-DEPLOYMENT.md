...
docker pull ghcr.io/paulasilvatech/specky:3.10.1            # or :latest
...
docker run --rm -p 127.0.0.1:3200:3200 \
  ...
  ghcr.io/paulasilvatech/specky:3.10.1

curl -s http://127.0.0.1:3200/health     # -> {"status":"ok","version":"3.10.1"}
```
