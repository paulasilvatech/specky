...
Feature directories use stable forward-slash identifiers in user-facing MCP messages on Windows. The release also adds Biome lint/format commands, broader unit coverage, and longer integration-test timeouts for subprocess-heavy suites under CPU contention.
